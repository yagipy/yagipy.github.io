...
上記をWebフロントとバックエンド両方とも行っていましたが、2022/3くらいからWebフロントはレビューをするのみになり、バックエンドを中心に行っています。
...
- 勉強会を企画することで、定期的に学習する習慣を作れたことはもちろんですが、それぞれの知識レベルを把握することで案件参画後のチケットの割り振りを効率よく行うことができました
